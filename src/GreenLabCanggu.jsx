...
const CANGGU_IMAGES = ["/images/hero-2.jpg"];

const COPY = {
  en: {
    topPill: "Green Lab Laundry • Canggu",
    nav: {
      home: "Home",
      langLeft: "ENG",
      langRight: "RUS",
    ...
    hero: {
      title: "Green Lab | Canggu",
      subtitle:
        "Eco-friendly laundry pickup & delivery in Canggu and nearby. Quick flow, gentle detergents, clean folding — made for Bali life.",
      ctaPrimary: "Request in WhatsApp",
      ctaSecondary: "Request in Telegram",
      badges: ["Eco detergents", "Canggu fast lane", "Pickup & delivery"],
    },
    quick: {
      title: "Fast, clean, predictable",
      text:
        "In Canggu we keep it simple: you message us, we pick up, we wash & fold, and we deliver back fresh. Share your pin and preferred time.",
    },
    steps: {
      title: "How it works",
      items: [
        {
          title: "Send your pin",
          desc: "Location + preferred pickup time — that’s enough.",
          icon: MapPin,
        },
        {
          title: "Pickup in Canggu",
          desc: "Courier picks up your bag — no item counting.",
          icon: Zap,
        },
        {
          title: "Wash & return",
          desc: "We wash, dry and fold — usually next day.",
          icon: Droplets,
        },
      ],
    },
    areas: {
      title: "Canggu coverage (popular)",
      desc:
        "Berawa • Batu Bolong • Echo Beach • Pererenan • Babakan • Seseh — and nearby streets. Drop your pin, we confirm instantly.",
      chips: ["Berawa", "Batu Bolong", "Echo Beach", "Pererenan", "Babakan", "Seseh"],
    },
    notes: {
      ...
      items: [
        ...
        "If you have delicates or special requests — tell us in chat.",
      ],
    },
    cards: {
      title: "Why Green Lab in Canggu",
      items: [
        {
          title: "Fresh feel",
          desc:
            "No heavy chemical vibe — just clean, airy freshness that fits Bali weather.",
          icon: Leaf,
        },
        {
          title: "Fast local flow",
          desc:
            "Canggu is our daily zone — pickup and routing are optimized.",
          icon: Clock,
        },
        {
          title: "Gentle handling",
          desc:
            "Delicates and favorite pieces get careful treatment and neat folding.",
          icon: Droplets,
        },
      ],
    },
    cta: {
      title: "Want pickup in Canggu today?",
      desc:
        "Send your pin and we’ll reply with the best pickup window for your area.",
      primary: "Open WhatsApp",
      secondary: "Copy message",
      copied: "Message copied ✅",
      message:
        "Hi Green Lab! I’d like to request laundry pickup in Canggu. My location: (paste pin). Preferred time: (today/tomorrow). Special notes: (if any).",
    },
    footer: {
      small: "© Green Lab Laundry, Canggu. Eco-friendly pickup & delivery.",
  ...
  ru: {
    ...
    hero: {
      title: "Green Lab | Чангу",
      subtitle:
        "Эко-прачечная с забором и доставкой по Чангу и рядом. Быстро, бережно, аккуратно сложено — под ритм Бали.",
      ctaPrimary: "Заказать в WhatsApp",
      ctaSecondary: "Заказать в Telegram",
      badges: ["Эко-средства", "Canggu fast lane", "Забор и доставка"],
    },
    quick: {
      title: "Быстро. Чисто. Понятно.",
      text:
        "В Чангу мы делаем всё максимально просто: вы пишете — мы забираем — стираем и складываем — возвращаем свежим. Пришлите геометку и удобное время.",
    },
    steps: {
      title: "Как это работает",
      items: [
        {
          title: "Кидаете геометку",
          desc: "Локация + удобное время забора — и всё.",
          icon: MapPin,
        },
        {
          title: "Забор в Чангу",
        ...
        },
        {
          ...
          desc: "Стираем, сушим, складываем — обычно на следующий день.",
          icon: Droplets,
        },
      ],
    },
    areas: {
      title: "Зона Чангу (популярное)",
      desc:
        "Berawa • Batu Bolong • Echo Beach • Pererenan • Babakan • Seseh — и соседние улицы. Пришлите геометку — подтвердим сразу.",
      chips: ["Berawa", "Batu Bolong", "Echo Beach", "Pererenan", "Babakan", "Seseh"],
    },
    notes: {
      ...
      items: [
        ...
        "Есть деликатные вещи или пожелания — напишите в чате.",
      ],
    },
    cards: {
      title: "Почему Green Lab в Чангу",
      items: [
        {
          title: "Ощущение свежести",
          desc:
            "Без «тяжёлой химии» — чистая, лёгкая свежесть, которая подходит под климат Бали.",
          icon: Leaf,
        },
        {
          title: "Быстрый локальный поток",
          desc:
            "Чангу — наша ежедневная зона: маршруты и забор настроены удобно.",
          icon: Clock,
        },
        {
          title: "Бережное обращение",
          desc:
            "Любимые вещи и деликатные ткани — под вниманием, складываем аккуратно.",
          icon: Droplets,
        },
      ],
    },
    cta: {
      title: "Нужен забор вещей в Чангу сегодня?",
      desc:
        "Пришлите геометку — ответим и предложим удобное окно забора под ваш район.",
      primary: "Открыть WhatsApp",
      secondary: "Скопировать текст",
      copied: "Скопировано ✅",
      message:
        "Привет, Green Lab! Хочу заказать забор вещей в Чангу. Моя локация: (геометка). Удобное время: (сегодня/завтра). Пожелания: (если есть).",
    },
    footer: {
      small: "© Green Lab Laundry, Canggu. Эко-стирка с забором и доставкой.",
...
function HeroCardRotator({ images, variant }) {
  const isMobile = variant === "mobile";
  return (
    <div
      className={`relative w-full overflow-hidden ${isMobile ? "" : "rounded-3xl border border-white/70 bg-white shadow-xl shadow-emerald-900/10"}`}
    ...
    >
      <div className={isMobile ? "relative h-[380px] w-screen" : "relative h-[460px] md:h-[560px]"}>
        <motion.img
          key={images[0]}
          src={images[0]}
          alt="Green Lab Canggu atmosphere"
          loading="eager"
          decoding="async"
...
/** -----------------------------
 *  Page: Green Lab | Canggu
 *  ----------------------------- */

export default function GreenLabCanggu() {
  ...
  const openWhatsApp = () => {
    window.open(waShareUrl(t.cta.message), "_blank", "noopener,noreferrer");
  };

  const openTelegram = () => {
    window.open(tgShareUrl(t.cta.message), "_blank", "noopener,noreferrer");
  };
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-stone-50 font-sans text-stone-800 selection:bg-emerald-200 selection:text-emerald-950">
        ...
        <div className="relative mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          >
            <div className="block lg:hidden -mx-6 -mt-14">
              <HeroCardRotator images={CANGGU_IMAGES} variant="mobile" />
            </div>
            <motion.div
              ...
              style={{ transformStyle: "preserve-3d" }}
            >
              <HeroCardRotator images={CANGGU_IMAGES} />
            </motion.div>
          </motion.div>
        </div>
      </section>
          ...
          <Reveal>
            <FlashlightCard className="p-8">
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div className="max-w-3xl">
                  ...
                  <div className="mt-4 space-y-2 text-sm text-stone-700">
                    ...
                    <div>Jl. Pantai Berawa No.36, Tibubeneng, Kuta Utara, Badung, Bali 80361</div>
                  </div>
                </div>
              ...
              <div className="mt-4 text-xs text-stone-400">
                * approximate average turnaround, depends on pickup time & load.
              </div>
            </FlashlightCard>
          </Reveal>
        </div>
      ...
      <section className="relative px-6 py-16">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
            <div className="absolute left-1/2 top-0 h-72 w-72 -translate-x-1/2 rounded-full bg-emerald-200/30 blur-3xl" />
      ...
      <section className="relative px-6 py-16">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
            <div className="absolute -left-10 top-10 h-60 w-60 rounded-full bg-emerald-200/35 blur-3xl" />
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-3 md:items-center">
                <div className="md:col-span-2">
                  ...
                  <p className="mt-4 text-xs text-stone-400">
                    WhatsApp opens via share link (no number needed). If you want direct chat number later — we’ll swap it fast.
                  </p>
                </div>
